...
public:
	...
	bool operator()(const vis::Box2d& bounds, const QuadTreeTileKey& key, const TileImages* images) override
	{
...
public:
	...
	bool operator()(const vis::Box2d& bounds, const QuadTreeTileKey& key) override
	{
...
{
	vis::Box2d leftBounds(osg::Vec2d(-math::piD(), -math::halfPiD()), osg::Vec2d(0, math::halfPiD()));
	vis::Box2d rightBounds(osg::Vec2d(0, -math::halfPiD()), osg::Vec2d(math::piD(), math::halfPiD()));
