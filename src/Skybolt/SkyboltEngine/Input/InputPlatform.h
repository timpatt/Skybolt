...
public:
	...
	//! @param i is the KeyCode enum value for keyboards, or the button index for other devices
	virtual bool isButtonPressed(size_t i) const = 0;

	virtual size_t getAxisCount() const = 0;
	//! Returns value in range [0, 1]
	virtual float getAxisState(size_t i) const = 0;
