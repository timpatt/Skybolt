...
#include "Planet.h"
#include "SkyboltVisOsg/GlobalSamplerUnit.h"
...
#include "SkyboltVisOsg/MatrixHelpers.h"
...
#include "SkyboltVisOsg/Renderable/Clouds/CloudsRenderTexture.h"
#include "SkyboltVisOsg/Renderable/Planet/PlanetSurface.h"
#include "SkyboltVisOsg/Renderable/Planet/PlanetSky.h"
...
#include "SkyboltVisOsg/Renderable/Planet/Tile/TileTextureCache.h"
#include "SkyboltVisOsg/Renderable/Billboard.h"
#include "SkyboltVisOsg/Renderable/Water/ReflectionCameraController.h"
#include "SkyboltVisOsg/Renderable/Water/Ocean.h"
...
static OsgTileFactory::TileTextures createSurfaceTileTextures(TileTextureCache& cache, const PlanetTileImages& images)
{
	...
	textures.elevationRerange = getElevationImageMetadataRequired(*images.heightMapImage.image).rerange;
	...
	mPlanetSurfaceListener(new MyPlanetSurfaceListener(this))
{
	...
	if (config.planetTileSources)
	{
		...
		surfaceConfig.imageFactory = config.imageFactory;
	...
	{
		auto factory = dynamic_cast<const WaveHeightTextureGeneratorFactory*>(config.visFactoryRegistry->getFirstItemOfType<WaveHeightTextureGenerator>().get());
		if (factory)
		{
		...
		{
			SKYBOLT_LOG(warning) << "WaveHeightTextureGeneratorFactory not found in visFactoryRegistry. Water will not render correctly.";
		}
	}
