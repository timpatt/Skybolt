...
struct BeamsConfig
{
	...
	{
		OsgBox2f extrusionPartBounds; //!< region of the texture map representing the extruded part of the beam
		OsgBox2f basePartBounds; //!< region of the texture map representing the circular base of the beam at the beam's origin
